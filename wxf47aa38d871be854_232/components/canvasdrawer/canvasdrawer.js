...
Component({
    ...
    cache: {},
    ready: function() {
        wx.removeStorageSync("canvasdrawer_pic_cache"), this.cache = wx.getStorageSync("canvasdrawer_pic_cache") || {}, this.ctx = wx.createCanvasContext("canvasdrawer", this)
    },
    methods: {
        readyPigment: function() {
            var t = this,
                e = this.data.painting,
                i = e.width,
                a = e.height,
                s = e.views;
            this.setData({
        ...
        getImagesInfo: function(t) {
            ...
            for (var s = [], n = function(t) {
                    s.push(new Promise((function(e, a) {
                        Promise.all(i.splice(20 * t, 20)).then((function(t) {
                            e(t)
                        })).catch((function(t) {
                            a(t)
                        }))
                    })))
                }, r = 0; r < Math.ceil(i.length / 20); r++) n(r);
        ...
        startPainting: function() {
            var e = this,
                ...
                s = i.painting.views;
            console.log(a);
            for (var n = 0, r = 0; n < s.length; n++)
                if ("image" === s[n].type) this.drawImage(t(t({}, s[n]), {}, {
                    url: a[r]
                })), r++;
                else if ("text" === s[n].type) {
        ...
        drawImage: function(t) {
            ...
            var e = t.url,
                ...
                h = t.height,
                c = void 0 === h ? 0 : h,
                g = (t.borderRadius, t.deg),
                d = void 0 === g ? 0 : g;
            0 !== d ? (this.ctx.translate(n + o / 2, a + c / 2), this.ctx.rotate(d * Math.PI / 180), this.ctx.drawImage(e, -o / 2, -c / 2, o, c)) : this.ctx.drawImage(e, n, a, o, c), this.ctx.restore()
        },
        drawText: function(e) {
            this.ctx.save();
            var i = e.MaxLineNumber,
                a = void 0 === i ? 2 : i,
                s = e.breakWord,
                n = void 0 !== s && s,
                r = e.color,
                ...
                P = e.textDecoration,
                b = void 0 === P ? "none" : P;
            if (this.ctx.beginPath(), this.ctx.setTextBaseline("top"), this.ctx.setTextAlign(p), this.ctx.setFillStyle(o), this.ctx.setFontSize(d), n) {
                for (var S = "", L = v, F = 1, M = 0; M < c.length; M++)
                    if (S += [c[M]], this.ctx.measureText(S).width > I) {
                        if (F === a && M !== c.length) {
                            S = S.substring(0, S.length - 1) + "...", this.ctx.fillText(S, w, L), this.drawTextLine(w, L, b, o, d, S), S = "";
                            break
                        }
                        this.ctx.fillText(S, w, L), this.drawTextLine(w, L, b, o, d, S), S = "", L += m, F++
                    }
                this.ctx.fillText(S, w, L), this.drawTextLine(w, L, b, o, d, S)
            } else this.ctx.fillText(c, w, v), this.drawTextLine(w, v, b, o, d, c);
            this.ctx.restore(), y && this.drawText(t(t({}, e), {}, {
                left: w + .3,
                top: v + .3,
                bolder: !1,
                textDecoration: "none"
