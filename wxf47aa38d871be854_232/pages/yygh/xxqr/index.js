...
Page({
    ...
    beforeConfirm: (0, t.throttle)((function(t) {
        ...
        i = t, this.setData({
            ...
            showCancel: !0,
            content: "预约成功后请按时就诊,如需取消,请在就诊日前一天的上午12点之前取消",
            success: function(t) {
                t.confirm ? s.setData({
                    showTip: !0
                }) : s.setData({
    ...
    doNext: function() {
        this.setData({
            showTip: !1
        }), (0, t.authSubMessage)(i, "appointmentAfterday", this.doConfirm, this)
    },
    doConfirm: function(i) {
        ...
        (0, t._request)({
            ...
            data: {
                ...
                visitDate: e.timestampToTime2(s.data.hids.visitDate),
                deptId: s.data.hids.deptId
            },
            method: "post",
            success: function(t) {
                if (console.log(t), 0 == t.status) return s.setData({
                    appointmentRecord: t.data.appointmentRecord
                }), e.setStorage("regInfo", t.data), e.hideLoading(), void e.reLaunch("/pages/yygh/result/result?recordId=" + t.data.appointmentRecord.recordId);
                if (-1 != t.status) {
                    ...
                    setTimeout((function() {
                        e.reLaunch("/pages/index/index?page=/pages/yygh/ghjl/index")
                    }), 3e3)
                } else s.toptips.show({
                    text: t.message
                })
