...
Page({
    ...
    onLoad: function(t) {
        this.setData({
            ...
            agreement: e.globalData.clInfoObj || {
                info_title: "C楼诊区预约方式",
                info_content: ""
            }
    ...
    doJump: function(t) {
        ...
        }) : this.data.deptCode ? a.navigateTo("/pages/yygh/xzys/index?deptCode=" + this.data.deptCode + "&deptName=" + this.data.deptName + "&selectVisitor=" + JSON.stringify(e) + "&tapIndex=" + this.data.tapIndex + "&showJzxz=" + this.data.showJzxz + "&area=" + this.data.area) : a.navigateTo("/pages/yygh/xzks/index?selectVisitor=" + JSON.stringify(e) + "&tapIndex=" + this.data.tapIndex + "&area=" + this.data.area)
    },
    consult: function(t) {
        wx.navigateBack()
    }
