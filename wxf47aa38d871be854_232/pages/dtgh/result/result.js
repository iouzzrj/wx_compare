...
Page({
    ...
    beforeDoPay: (0, e.throttle)((function(t) {
        this.payParam = t;
        var i = this;
        (0, e.needSubMessage)("appointmentToday", (function(t) {
            t ? i.setData({
                showTip: !0
            }) : (0, e.authSubMessage)(i.payParam, "appointmentToday", i.doPay, i)
        }))
    }), 2e3),
    doNext: function() {
        this.setData({
            showTip: !1
        }), (0, e.authSubMessage)(this.payParam, "appointmentToday", this.doPay, this)
    },
    doPay: function() {
        ...
        wx.requestPayment({
            ...
            paySign: e.sign,
            success: function(e) {
                "requestPayment:ok" == e.errMsg && (t.showLoading(!1, "检测支付状态..."), wx.reLaunch({
                    url: "/pages/grzx/index"
                }), wx.navigateTo({
                    url: "/pages/dtgh/ghjl/index"
                }))
            },
            fail: function(e) {
                t.showToast({
    ...
    _getSurplusTime: function(t) {
        ...
        (0, e._request)({
            loading: !0,
            url: "/api/appointmentRecord/getSurplusTime.json",
            data: {
                recordId: t
            },
            success: function(e) {
