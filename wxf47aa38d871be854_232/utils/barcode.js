...
exports.code128 = function(r, o, l, d) {
    ...
    for (var p = function(r) {
            ...
            for (var g = 0; g < f.length; g++) {
                ...
                p = p.concat(R(v, w, u.currcs)), u.currcs == h && g++
            }
            ...
            return p.push(_ % 103), p.push(106), p;
             function R(t, r, i) {
                ...
                return -1 != f ? (a.push(f), a.push(n(t))) : i == h ? a.push(n(t, r)) : a.push(n(t)), u.currcs = i, a
            }
        }(o), g = new u(r, l, d), v = g.area.width / (11 * (p.length - 3) + 35), w = g.area.left, _ = g.area.top, b = 0; b < p.length; b++)
