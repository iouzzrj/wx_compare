 ...
 function h(t, n, r, o) {
    return t && e.index.showLoading({
        ...
        c.globalData.shake && -1 == n.indexOf("/common") && (s += "@" + c.globalData.version), e.index.uploadFile({
            ...
            filePath: u.filePath || "",
            success: function(e) {
                console.log("上传文件反参：", e);
                var c = b(u, e);
                console.log("上传文件反参解密：", c), 1e3 == c.status || "401" == c.code ? d().then((function(u) {
                    0 == u.status ? h(t, n, r, o).then((function(t) {
                        i(t)
                    })).catch((function(t) {
                        a(t)
                    })) : a(e)
...
var g = function t(n) {
        ...
        return new Promise((function(r, l) {
            e.index.request({
                ...
                success: function(i) {
                    var a = b(n, i);
                    200 == i.statusCode ? 1e3 == a.status || "401" == a.code ? d().then((function(e) {
...
}, exports.getVerifyId = function(t) {
    return new Promise((function(n, e) {
        var o = {
            loading: !0,
            method: "POST",
            data: t,
            url: r.url.getVerifyId,
            header: l()
        };
        return g(o).then((function(t) {
            n(t)
