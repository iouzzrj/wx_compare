...
var e, t, r, o = require("./decode.js"),
    c = require("./encode.js"),
    n = require("./escape.js");
! function(e) {
    e[e.XML = 0] = "XML", e[e.HTML = 1] = "HTML"
}(e = exports.EntityLevel || (exports.EntityLevel = {})),
function(e) {
    e[e.Legacy = 0] = "Legacy", e[e.Strict = 1] = "Strict"
}(t = exports.DecodingMode || (exports.DecodingMode = {})),
function(e) {
    ...
    return n.level === e.HTML ? n.mode === t.Strict ? (0, o.decodeHTMLStrict)(r) : (0, o.decodeHTML)(r) : (0, o.decodeXML)(r)
}, exports.decodeStrict = function(r, c) {
    void 0 === c && (c = e.XML);
    var n = "number" == typeof c ? {
        level: c
    } : c;
    return n.level === e.HTML ? n.mode === t.Legacy ? (0, o.decodeHTML)(r) : (0, o.decodeHTMLStrict)(r) : (0, o.decodeXML)(r)
}, exports.encode = function(t, o) {
    void 0 === o && (o = e.XML);
    var d = "number" == typeof o ? {
        level: o
    } : o;
    return d.mode === r.UTF8 ? (0, n.escapeUTF8)(t) : d.mode === r.Attribute ? (0, n.escapeAttribute)(t) : d.mode === r.Text ? (0, n.escapeText)(t) : d.level === e.HTML ? d.mode === r.ASCII ? (0, c.encodeNonAsciiHTML)(t) : (0, c.encodeHTML)(t) : (0, n.encodeXML)(t)
};
