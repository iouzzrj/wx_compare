...
var t = require("./Tokenizer.js"),
    ...
    u = function() {
        function i(e, i) {
            var s, n, o, r, a;
            void 0 === i && (i = {}), this.options = i, this.startIndex = 0, this.endIndex = 0, this.openTagStart = 0, this.tagname = "", this.attribname = "", this.attribvalue = "", this.attribs = null, this.stack = [], this.foreignContext = [], this.buffers = [], this.bufferOffset = 0, this.writeIndex = 0, this.ended = !1, this.cbs = null != e ? e : {}, this.lowerCaseTagNames = null !== (s = i.lowerCaseTags) && void 0 !== s ? s : !i.xmlMode, this.lowerCaseAttributeNames = null !== (n = i.lowerCaseAttributeNames) && void 0 !== n ? n : !i.xmlMode, this.tokenizer = new(null !== (o = i.Tokenizer) && void 0 !== o ? o : t.default)(this.options, this), null === (a = (r = this.cbs).onparserinit) || void 0 === a || a.call(r, this)
        }
        return i.prototype.ontext = function(t, e) {
            ...
            this.endIndex = n - 1, null === (s = (i = this.cbs).ontext) || void 0 === s || s.call(i, (0, e.fromCodePoint)(t)), this.startIndex = n
            ...
            this.isVoidElement(t) || (this.stack.push(t), l.has(t) ? this.foreignContext.push(!0) : c.has(t) && this.foreignContext.push(!1)), null === (n = (s = this.cbs).onopentagname) || void 0 === n || n.call(s, t), this.cbs.onopentag && (this.attribs = {})
            ...
            if (this.lowerCaseTagNames && (h = h.toLowerCase()), (l.has(h) || c.has(h)) && this.foreignContext.pop(), this.isVoidElement(h)) this.options.xmlMode || "br" !== h || (null === (s = (i = this.cbs).onopentagname) || void 0 === s || s.call(i, "br"), null === (o = (n = this.cbs).onopentag) || void 0 === o || o.call(n, "br", {}, !0), null === (a = (r = this.cbs).onclosetag) || void 0 === a || a.call(r, "br", !1));
            else {
                var d = this.stack.lastIndexOf(h);
                if (-1 !== d)
                    if (this.cbs.onclosetag)
                        for (var u = this.stack.length - d; u--;) this.cbs.onclosetag(this.stack.pop(), 0 !== u);
            ...
            var s, n, o, r;
            this.endIndex = e, null === (n = (s = this.cbs).oncomment) || void 0 === n || n.call(s, this.getSlice(t, e - i)), null === (r = (o = this.cbs).oncommentend) || void 0 === r || r.call(o), this.startIndex = e + 1
        }, i.prototype.oncdata = function(t, e, i) {
            var s, n, o, r, a, h, l, c, d, u;
            this.endIndex = e;
            var p = this.getSlice(t, e - i);
            this.options.xmlMode || this.options.recognizeCDATA ? (null === (n = (s = this.cbs).oncdatastart) || void 0 === n || n.call(s), null === (r = (o = this.cbs).ontext) || void 0 === r || r.call(o, p), null === (h = (a = this.cbs).oncdataend) || void 0 === h || h.call(a)) : (null === (c = (l = this.cbs).oncomment) || void 0 === c || c.call(l, "[CDATA[".concat(p, "]]")), null === (u = (d = this.cbs).oncommentend) || void 0 === u || u.call(d)), this.startIndex = e + 1
            ...
            var e, i;
            this.ended ? null === (i = (e = this.cbs).onerror) || void 0 === i || i.call(e, Error(".end() after done!")) : (t && this.write(t), this.ended = !0, this.tokenizer.end())
