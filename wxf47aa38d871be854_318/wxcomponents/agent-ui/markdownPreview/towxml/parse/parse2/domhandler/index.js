...
var t = require("../../../../../../../@babel/runtime/helpers/typeof"),
    e = require("../domelementtype/index.js"),
    n = require("./node.js"),
    o = {
        withStartIndices: !1,
        withEndIndices: !1,
    ...
    i = function() {
        function i(e, i, s) {
            this.dom = [], this.root = new n.Document(this.dom), this.done = !1, this.tagStack = [this.root], this.lastNode = null, this.parser = null, "function" == typeof i && (s = i, i = o), "object" === t(e) && (i = e, e = void 0), this.callback = null != e ? e : null, this.options = null != i ? i : o, this.elementCB = null != s ? s : null
        }
        return i.prototype.onparserinit = function(t) {
            ...
            var i = this.options.xmlMode ? e.ElementType.Tag : void 0,
                s = new n.Element(t, o, void 0, i);
            this.addNode(s), this.tagStack.push(s)
        }, i.prototype.ontext = function(t) {
            var o = this.lastNode;
            if (o && o.type === e.ElementType.Text) o.data += t, this.options.withEndIndices && (o.endIndex = this.parser.endIndex);
            else {
                var i = new n.Text(t);
                this.addNode(i), this.lastNode = i
            }
        }, i.prototype.oncomment = function(t) {
            if (this.lastNode && this.lastNode.type === e.ElementType.Comment) this.lastNode.data += t;
            else {
