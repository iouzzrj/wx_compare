    ...
    h = function() {
        function h(t, i) {
            var n = t.xmlMode,
                ...
                r = t.decodeEntities,
                o = void 0 === r || r;
            this.cbs = i, this.state = e.Text, this.buffer = "", this.sectionStart = 0, this.index = 0, this.baseState = e.Text, this.isSpecial = !1, this.running = !0, this.offset = 0, this.sequenceIndex = 0, this.trieIndex = 0, this.trieCurrent = 0, this.entityResult = 0, this.entityExcess = 0, this.xmlMode = a, this.decodeEntities = o, this.entityTrie = a ? s.xmlDecodeTree : s.htmlDecodeTree
        }
        return h.prototype.reset = function() {
            ...
            i === t.Lt || !this.decodeEntities && this.fastForwardTo(t.Lt) ? (this.index > this.sectionStart && this.cbs.ontext(this.sectionStart, this.index), this.state = e.BeforeTagName, this.sectionStart = this.index) : this.decodeEntities && i === t.Amp && (this.state = e.BeforeEntity)
            ...
            t === o.Cdata[this.sequenceIndex] ? ++this.sequenceIndex === o.Cdata.length && (this.state = e.InCommentLike, this.currentSequence = o.CdataEnd, this.sequenceIndex = 0, this.sectionStart = this.index + 1) : (this.sequenceIndex = 0, this.state = e.InDeclaration, this.stateInDeclaration(t))
            ...
            if (i === t.ExclamationMark) this.state = e.BeforeDeclaration, this.sectionStart = this.index + 1;
            else if (i === t.Questionmark) this.state = e.InProcessingInstruction, this.sectionStart = this.index + 1;
            ...
            } else i === t.Slash ? this.state = e.BeforeClosingTagName : (this.state = e.Text, this.stateText(i))
        }, h.prototype.stateInTagName = function(t) {
            a(t) && (this.cbs.onopentagname(this.sectionStart, this.index), this.sectionStart = -1, this.state = e.BeforeAttributeName, this.stateBeforeAttributeName(t))
        }, h.prototype.stateBeforeClosingTagName = function(i) {
            n(i) || (i === t.Gt ? this.state = e.Text : (this.state = this.isTagStartChar(i) ? e.InClosingTagName : e.InSpecialComment, this.sectionStart = this.index))
        }, h.prototype.stateInClosingTagName = function(i) {
            (i === t.Gt || n(i)) && (this.cbs.onclosetag(this.sectionStart, this.index), this.sectionStart = -1, this.state = e.AfterClosingTagName, this.stateAfterClosingTagName(i))
            ...
            i === t.Gt ? (this.cbs.onopentagend(this.index), this.isSpecial ? (this.state = e.InSpecialTag, this.sequenceIndex = 0) : this.state = e.Text, this.baseState = this.state, this.sectionStart = this.index + 1) : i === t.Slash ? this.state = e.InSelfClosingTag : n(i) || (this.state = e.InAttributeName, this.sectionStart = this.index)
        }, h.prototype.stateInSelfClosingTag = function(i) {
            i === t.Gt ? (this.cbs.onselfclosingtag(this.index), this.state = e.Text, this.baseState = e.Text, this.sectionStart = this.index + 1, this.isSpecial = !1) : n(i) || (this.state = e.BeforeAttributeName, this.stateBeforeAttributeName(i))
        }, h.prototype.stateInAttributeName = function(i) {
            (i === t.Eq || a(i)) && (this.cbs.onattribname(this.sectionStart, this.index), this.sectionStart = -1, this.state = e.AfterAttributeName, this.stateAfterAttributeName(i))
        }, h.prototype.stateAfterAttributeName = function(s) {
            s === t.Eq ? this.state = e.BeforeAttributeValue : s === t.Slash || s === t.Gt ? (this.cbs.onattribend(i.NoValue, this.index), this.state = e.BeforeAttributeName, this.stateBeforeAttributeName(s)) : n(s) || (this.cbs.onattribend(i.NoValue, this.index), this.state = e.InAttributeName, this.sectionStart = this.index)
        }, h.prototype.stateBeforeAttributeValue = function(i) {
            i === t.DoubleQuote ? (this.state = e.InAttributeValueDq, this.sectionStart = this.index + 1) : i === t.SingleQuote ? (this.state = e.InAttributeValueSq, this.sectionStart = this.index + 1) : n(i) || (this.sectionStart = this.index, this.state = e.InAttributeValueNq, this.stateInAttributeValueNoQuotes(i))
        }, h.prototype.handleInAttributeValue = function(s, n) {
            s === n || !this.decodeEntities && this.fastForwardTo(n) ? (this.cbs.onattribdata(this.sectionStart, this.index), this.sectionStart = -1, this.cbs.onattribend(n === t.DoubleQuote ? i.Double : i.Single, this.index), this.state = e.BeforeAttributeName) : this.decodeEntities && s === t.Amp && (this.baseState = this.state, this.state = e.BeforeEntity)
            ...
            n(s) || s === t.Gt ? (this.cbs.onattribdata(this.sectionStart, this.index), this.sectionStart = -1, this.cbs.onattribend(i.Unquoted, this.index), this.state = e.BeforeAttributeName, this.stateBeforeAttributeName(s)) : this.decodeEntities && s === t.Amp && (this.baseState = this.state, this.state = e.BeforeEntity)
            ...
            (i === t.Gt || this.fastForwardTo(t.Gt)) && (this.cbs.ondeclaration(this.sectionStart, this.index), this.state = e.Text, this.sectionStart = this.index + 1)
        }, h.prototype.stateInProcessingInstruction = function(i) {
            (i === t.Gt || this.fastForwardTo(t.Gt)) && (this.cbs.onprocessinginstruction(this.sectionStart, this.index), this.state = e.Text, this.sectionStart = this.index + 1)
        }, h.prototype.stateBeforeComment = function(i) {
            i === t.Dash ? (this.state = e.InCommentLike, this.currentSequence = o.CommentEnd, this.sequenceIndex = 2, this.sectionStart = this.index + 1) : this.state = e.InDeclaration
        }, h.prototype.stateInSpecialComment = function(i) {
            (i === t.Gt || this.fastForwardTo(t.Gt)) && (this.cbs.oncomment(this.sectionStart, this.index, 0), this.state = e.Text, this.sectionStart = this.index + 1)
        }, h.prototype.stateBeforeSpecialS = function(t) {
            var i = 32 | t;
            i === o.ScriptEnd[3] ? this.startSpecial(o.ScriptEnd, 4) : i === o.StyleEnd[3] ? this.startSpecial(o.StyleEnd, 4) : (this.state = e.InTagName, this.stateInTagName(t))
        }, h.prototype.stateBeforeEntity = function(i) {
            this.entityExcess = 1, this.entityResult = 0, i === t.Num ? this.state = e.BeforeNumericEntity : i === t.Amp || (this.trieIndex = 0, this.trieCurrent = this.entityTrie[0], this.state = e.InNamedEntity, this.stateInNamedEntity(i))
            ...
            if (i) {
                ...
                if (this.allowLegacyEntity() || e === t.Semi) {
                    ...
                    a > this.sectionStart && this.emitPartial(this.sectionStart, a), this.entityResult = this.trieIndex, this.trieIndex += n, this.entityExcess = 0, this.sectionStart = this.index + 1, 0 === n && this.emitNamedEntity()
            ...
            (32 | i) === t.LowerX ? (this.entityExcess++, this.state = e.InHexEntity) : (this.state = e.InNumericEntity, this.stateInNumericEntity(i))
        }, h.prototype.emitNumericEntity = function(t) {
            var i = this.index - this.entityExcess - 1;
            i + 2 + Number(this.state === e.InHexEntity) !== this.index && (i > this.sectionStart && this.emitPartial(this.sectionStart, i), this.sectionStart = this.index + Number(t), this.emitCodePoint((0, s.replaceCodePoint)(this.entityResult))), this.state = this.baseState
        }, h.prototype.stateInNumericEntity = function(e) {
            e === t.Semi ? this.emitNumericEntity(!0) : r(e) ? (this.entityResult = 10 * this.entityResult + (e - t.Zero), this.entityExcess++) : (this.allowLegacyEntity() ? this.emitNumericEntity(!1) : this.state = this.baseState, this.index--)
        }, h.prototype.stateInHexEntity = function(e) {
            e === t.Semi ? this.emitNumericEntity(!0) : r(e) ? (this.entityResult = 16 * this.entityResult + (e - t.Zero), this.entityExcess++) : ! function(e) {
                return e >= t.UpperA && e <= t.UpperF || e >= t.LowerA && e <= t.LowerF
            }(e) ? (this.allowLegacyEntity() ? this.emitNumericEntity(!1) : this.state = this.baseState, this.index--) : (this.entityResult = 16 * this.entityResult + ((32 | e) - t.LowerA + 10), this.entityExcess++)
