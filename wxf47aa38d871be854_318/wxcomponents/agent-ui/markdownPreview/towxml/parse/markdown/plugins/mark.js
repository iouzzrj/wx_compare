...
! function(n) {
    if ("object" == ("undefined" == typeof exports ? "undefined" : e(exports)) && "undefined" != typeof module) module.exports = n();
        ...
        1: [function(e, n, t) {
            n.exports = function(e) {
                e.inline.ruler.before("emphasis", "mark", (function(e, n) {
                    ...
                    for (o % 2 && (e.push("text", "", 0).content = i, o--), t = 0; o > t; t += 2) e.push("text", "", 0).content = i + i, e.delimiters.push({
                        marker: s,
                        jump: t,
                    ...
                    for (n = 0; u > n; n++) 61 === (r = s[n]).marker && -1 !== r.end && (o = s[r.end], (i = e.tokens[r.token]).type = "mark_open", i.tag = "mark", i.nesting = 1, i.markup = "==", i.content = "", (i = e.tokens[o.token]).type = "mark_close", i.tag = "mark", i.nesting = -1, i.markup = "==", i.content = "", "text" === e.tokens[o.token - 1].type && "=" === e.tokens[o.token - 1].content && f.push(o.token - 1));
                    for (; f.length;) {
