...
var e = require("../../../../@babel/runtime/helpers/toConsumableArray"),
    ...
    n = require("./choose-and-upload-file.js"),
    a = require("./utils.js"),
    l = {
        name: "uniFilePicker",
        components: {
        ...
        created: function() {
            s._r.config && s._r.config.provider || (this.noSpace = !0, s._r.chooseAndUploadFile = n.chooseAndUploadFile), this.form = this.getForm("uniForms"), this.formItem = this.getForm("uniFormsItem"), this.form && this.formItem && this.formItem.name && (this.rename = this.formItem.name, this.form.inputChildrens.push(this))
        },
        methods: {
                    ...
                    return i().wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                                        ...
                                        var e = r(i().mark((function e(t) {
                                            ...
                                            return i().wrap((function(e) {
                                                for (;;) switch (e.prev = e.next) {
                                                    case 0:
                                                        if ("", r = t.fileID ? t.fileID : t.url, e.t0 = /cloud:\/\/([\w.]+\/?)\S*/.test(r), !e.t0) {
                                                            e.next = 8;
                                                            break
                                                        }
                            ...
                            case 12:
                                ...
                                return l = e[a], t.next = 16, n(l);
                            case 16:
                                a++, t.next = 12;
                                break;
                            case 19:
                                s.localValue = e, s.form && s.formItem && !s.is_reset && (s.is_reset = !1, s.formItem.setValue(s.localValue)), o = Object.keys(e).length > 0 ? e : [], s.files = [].concat(o);
                            case 22:
                            case "end":
                                return t.stop()
                        }
            ...
            chooseFiles: function() {
                var e = this,
                    t = a.get_extname(this.fileExtname);
                s._r.chooseAndUploadFile({
                ...
                return r(i().mark((function r() {
                    ...
                    return i().wrap((function(i) {
                        for (;;) switch (i.prev = i.next) {
                            case 0:
                                n = a.get_extname(s.fileExtname), (1 === Number(s.limitLength) && s.disablePreview && !s.disabled || "object" === s.returnType) && (s.files = []), l = a.get_files_and_is_max(e, n), o = l.filePaths, u = l.files, n && n.length > 0 || (o = e.tempFilePaths, u = e.tempFiles), c = [], f = 0;
                            case 6:
                                if (!(f < u.length) || s.limitLength - s.files.length <= 0) {
                                    i.next = 15;
                                    break
                                }
                                return u[f].uuid = Date.now(), i.next = 10, a.get_file_data(u[f], s.fileMediatype);
                            case 10:
                                    ...
                                    return i().wrap((function(t) {
                                        for (;;) switch (t.prev = t.next) {
                                            ...
                                            case 3:
                                                ...
                                                s.files[c].url = o.path, s.files[c].status = "error", s.files[c].errMsg = o.errMsg, n.push(s.files[c]), l.push(s.files[c].url), t.next = 19;
                                                break;
                                            case 7:
                                            ...
                                            case 14:
                                                s.files[c].url = o.url;
                                            case 15:
                                                s.files[c].status = "success", s.files[c].progress += 1, r.push(s.files[c]), a.push(s.files[c].fileID);
                                            case 19:
                                            case "end":
                                                return t.stop()
                                        }
            ...
            setEmit: function() {
                var t = [];
                "object" === this.returnType ? (t = this.backObject(this.files)[0], this.localValue = t || null) : (t = this.backObject(this.files), this.localValue || (this.localValue = []), this.localValue = e(t)), this.$emit("update:modelValue", this.localValue)
            },
                    ...
                    return i().wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                return e = {
                                    fileList: [].concat(e)
                                }, t.next = 3, s._r.getTempFileURL(e);
                            case 3:
...
var o = s._export_sfc(l, [
    ["render", function(e, t, i, r, n, a) {
        return s.e({
            a: i.title
        }, i.title ? {
            b: s.t(i.title),
            c: s.t(a.filesList.length),
            d: s.t(a.limitLength)
        } : {}, {
            e: "image" === i.fileMediatype && "grid" === a.showType
        }, "image" === i.fileMediatype && "grid" === a.showType ? {
            f: s.o(a.uploadFiles, "6f"),
            g: s.o(a.choose, "28"),
            h: s.o(a.delFile, "89"),
            i: s.p({
                readonly: i.readonly,
                "image-styles": i.imageStyles,
                "files-list": a.filesList,
                limit: a.limitLength,
                disablePreview: i.disablePreview,
                delIcon: i.delIcon
            })
        } : {}, {
            j: "image" !== i.fileMediatype || "grid" !== a.showType
        }, "image" !== i.fileMediatype || "grid" !== a.showType ? {
            k: s.o(a.uploadFiles, "c9"),
            l: s.o(a.choose, "d2"),
            m: s.o(a.delFile, "ba"),
            n: s.p({
                readonly: i.readonly,
