...
var d, n, i = require("./decode_codepoint.js");
 function a(e) {
    return function(r, o) {
        for (var i = "", a = 0, f = 0;
            (f = r.indexOf("&", f)) >= 0;)
            if (i += r.slice(a, f), a = f, f += 1, r.charCodeAt(f) !== d.NUM) {
                for (var u = 0, s = 1, E = 0, L = e[E]; f < r.length && !((E = c(e, L, E + 1, r.charCodeAt(f))) < 0); f++, s++) {
                ...
                if (0 !== u) i += 1 === (T = (e[u] & n.VALUE_LENGTH) >> 14) ? String.fromCharCode(e[u] & ~n.VALUE_LENGTH) : 2 === T ? String.fromCharCode(e[u + 1]) : String.fromCharCode(e[u + 1], e[u + 2]), a = f - s + 1
            } else {
                var l = f + 1,
                    p = 10,
                    x = r.charCodeAt(l);
                ...
                if (l !== f) {
                    var C = r.substring(l, f),
                        O = parseInt(C, p);
                    if (r.charCodeAt(f) === d.SEMI) f += 1;
                    else if (o) continue;
                    i += (0, t.default)(O), a = f
                }
            }
