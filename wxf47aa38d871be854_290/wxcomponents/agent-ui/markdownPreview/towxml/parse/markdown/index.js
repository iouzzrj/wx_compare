...
var r, n = require("../../config"),
    ...
    u = require("./markdown")(i);
u.use(require("./plugins/sub")), u.use(require("./plugins/sup")), u.use(require("./plugins/ins")), u.use(require("./plugins/mark")), u.renderer.rules.emoji = function(e, r) {
    var n = e[r];
