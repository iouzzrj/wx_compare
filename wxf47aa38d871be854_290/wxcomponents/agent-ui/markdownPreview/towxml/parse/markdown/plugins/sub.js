    ...
    return function e(r, n, o) {
        ...
        1: [function(e, r) {
            function n(e, r) {
                ...
                return n && u + 1 !== e.pos ? (t = e.src.slice(u + 1, e.pos)).match(/(^|[^\\])(\\\\)*\s/) ? (e.pos = u, !1) : (e.posMax = e.pos, e.pos = u + 1, e.push("sub_open", "sub", 1).markup = "~", e.push("text", "", 0).content = t.replace(o, "$1"), e.push("sub_close", "sub", -1).markup = "~", e.pos = e.posMax + 1, e.posMax = i, !0) : (e.pos = u, !1)
            }
            var o = /\\([ \\!"#$%&'()*+,.\/:;<=>?@[\]^_`{|}~-])/g;
