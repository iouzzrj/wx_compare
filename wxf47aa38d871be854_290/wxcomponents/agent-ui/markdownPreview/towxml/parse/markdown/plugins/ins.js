        ...
        1: [function(e, n, t) {
            n.exports = function(e) {
                e.inline.ruler.before("emphasis", "ins", (function(e, n) {
                    ...
                    for (r % 2 && (e.push("text", "", 0).content = i, r--), t = 0; r > t; t += 2) e.push("text", "", 0).content = i + i, e.delimiters.push({
                        marker: f,
                        jump: t,
                    ...
                    for (n = 0; u > n; n++) 43 === (o = f[n]).marker && -1 !== o.end && (r = f[o.end], (i = e.tokens[o.token]).type = "ins_open", i.tag = "ins", i.nesting = 1, i.markup = "++", i.content = "", (i = e.tokens[r.token]).type = "ins_close", i.tag = "ins", i.nesting = -1, i.markup = "++", i.content = "", "text" === e.tokens[r.token - 1].type && "+" === e.tokens[r.token - 1].content && s.push(r.token - 1));
                    for (; s.length;) {
