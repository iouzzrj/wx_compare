...
var t = require("../@babel/runtime/helpers/classCallCheck"),
    ...
    s = new(function() {
        function s() {
            return t(this, s), s.instance ? s.instance : (s.instance = this, this.mqttClient = null, this.userName = "", this.passWord = "", this.clientId = "", this.topics = [], this.keepAliveInterval = 0, this.cleanSession = !0, this.timeout = 0, this.mqttIp = "", this.onMessage, this)
        }
        return e(s, [{
            key: "getMqttClient",
            value: function() {
