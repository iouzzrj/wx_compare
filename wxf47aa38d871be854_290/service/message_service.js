...
var e = require("../@babel/runtime/helpers/classCallCheck"),
    ...
    i = require("./mqtt_service.js"),
    n = require("../utils/util.js"),
    r = require("./userMessageBadge.js").useMessageBadge(1).unreadCount;
getApp();
var o = new(function() {
    function u() {
    ...
    return t(u, [{
        ...
        value: function() {
            ...
            a && (console.log("医生信息", a), this.patientUniqueId = a.uniqueId, this.imData = a.imInfo, i.mqttService.initMqttConfig(this.imData, this.onMessage), setTimeout((function() {
        ...
        key: "dispostMqtt",
        value: function() {
            this.imData = void 0, i.mqttService.getMqttClientConnect() && i.mqttService.disconnect(), this.dispostEmit()
        }
    }, {
        key: "dispostEmit",
        value: function() {
                ...
                if (console.log("接诊中记录:", t), "0" == t.code) {
                    if (e.recordList.data = t.content.list, t.content.list) {
                        for (var a = s.index.getStorageSync("imLoginInfo"), i = t.content.list.reduce((function(e, t) {
                            ...
                            u.msgSummary[a.uniqueId].unread > 0 && (n[u.acceptRecord[0].sessionId] = u.msgSummary[a.uniqueId].unread), u.msgSummary.mark && (e.MessageInfoEnd.data[u.acceptRecord[0].sessionId] = {
                                tip: u.msgSummary.mark.tip,
                                time: u.msgSummary.mark.time
                            })
                        }
                        e.NewMessageNumber.data = n, console.log("未读消息数：", i), e.NewMessageNumber.totalNumber = i, r.value = i
                    }
